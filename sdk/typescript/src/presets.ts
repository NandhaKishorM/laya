...
export function triageQuestions(): typeof triagePreset {
  return structuredClone(triagePreset);
}
...
export function guardQuestions(): typeof guardPreset {
  return structuredClone(guardPreset);
}

const moderationPreset = {
  "toxic": {
    "type": "noul",
...
export function moderationQuestions(): typeof moderationPreset {
  return structuredClone(moderationPreset);
}
...
export function routerQuestions(): typeof routerPreset {
  return structuredClone(routerPreset);
}

export function emailQuestions(): typeof emailPreset;
