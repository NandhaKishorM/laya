...
SCRIPTS = [
    ...
    ("bengali", "আমাকে দুইবার চার্জ করা হয়েছে", "bengali"),
    ("cherokee", "ᎣᏏᏲ ᏣᎳᎩ", "cherokee"),
    ("syriac", "ܫܠܡܐ ܥܠܝܟܘܢ", "syriac"),
    ("thaana", "ސަލާމް އަލައިކުމް", "thaana"),
    ("nko", "ߒߞߏ", "nko"),
    ("canadian aboriginal", "ᐊᓘᓐᓇ ᑕᐃᒪ", "canadian_aboriginal"),
    ("mongolian", "ᠰᠠᠢᠨ ᠪᠠᠢᠨ᠎ᠠ", "mongolian"),
    ("tifinagh", "ⵜⴰⵎⴰⵣⵉⵖⵜ", "tifinagh"),
    ("bopomofo", "ㄋㄧ ㄏㄠ", "bopomofo"),
    ("yi", "ꆈꌠꁱꂷ", "yi"),
    ("javanese", "ꦱꦸꦒꦼꦁ", "javanese"),
    ("halfwidth katakana", "ｺﾝﾆﾁﾊ", "kana"),
    ("unlisted alphabetic script", "𐒀𐒖𐒆𐒖", "other"),
...
cases = [
    ...
    ("bengali text", {"body": "আমার টাকা ফেরত চাই"}, Q_GENERIC, {}, "multilingual"),
    ("cherokee text", {"body": "ᎣᏏᏲ ᏣᎳᎩ"}, Q_GENERIC, {}, "multilingual"),
    ("unlisted script", {"body": "𐒀𐒖𐒆𐒖"}, Q_GENERIC, {}, "multilingual"),
